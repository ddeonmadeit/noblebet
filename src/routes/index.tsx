...
function Index() {
  return (
    <main className="min-h-screen relative overflow-x-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-6 py-6 sm:py-12 md:py-20">
        <header className="text-center mb-6 sm:mb-10">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-semibold tracking-tight text-foreground">
            We Will Buy Your Betting Account For{" "}
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              $350
            </span>
          </h1>
          <p className="mt-1 text-sm sm:text-lg font-semibold text-foreground">
            Australian's Only
          </p>
